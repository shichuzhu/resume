...
\vspace{-40pt}
\begin{center}
	\textbf{Objective:} Software development engineer internship position, Summer 2019.
\end{center}
\vspace{-20pt}
\section{Education}
\vspace{-5pt}
...
\begin{itemize}
	\item{\cventry{Fall 2017}
	      ...
	      {}
	      {Distributed Systems,
		      \href{https://gitlab-beta.engr.illinois.edu/szhu28/ShichuCS425MP}{\underline{gitlab-beta.engr.illinois.edu/szhu28/ShichuCS425MP}}}
	      {
		      %   \emph{Source on demand}%
		      Implemented a gossip-style failure detector for a distributed system connected by arbitrary network topology.
		      Programming techniques included building a utility RPC module with socket and decorator in \underline{Python}.}
	      }
