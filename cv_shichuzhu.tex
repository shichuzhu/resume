...
\social[linkedin][www.linkedin.com/in/shichu-stuart-zhu-11aa8856/]{shichu-zhu}
...
\vspace{-5pt}
\begin{itemize}
	\item {\cventry{August 2018--December 2019}
	      {Computer Science}
...
\begin{itemize}
	...
	\item{\cventry{February 2020--Present}
	      {Software Engineer}
	      {Google}
	      %   {}
	      {Cambridge, MA, USA and Kitchener, ON, Canada}
	      {Google Cloud}
	      {Design and build Golang software automation that manages the configuration of network devices forming the backbone of Google Cloud WAN.}
	      }
	      
	\item{\cventry{May 2019--August 2019}
